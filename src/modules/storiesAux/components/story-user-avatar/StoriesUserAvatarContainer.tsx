...
import { useStoriesScroll } from "@/modules/storiesAux/hooks/useStoriesScroll";
    ...
    <div className="relative">
      ...
      >
        {USERS.map((user, index) => (
          <StoryBubble key={user.id} user={user} index={index} />
        ))}
      </div>
      {showScrollRight && (
        <StoriesArrowButton
