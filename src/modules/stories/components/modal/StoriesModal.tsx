       ...
       <StoriesModalHeader onClick={handleModal}/>
        <div className="grid place-items-center w-full h-full">
            ...
            <div className="flex items-center justify-between">
              <StoryAvatar userName={userName} avatar={avatar} className="text-white grid-flow-col gap-3" userNameWidth="w-40" />
              <button className="text-white text-2xl"><RiPlayFill /></button>
            </div>
