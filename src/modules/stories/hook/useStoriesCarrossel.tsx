...
import { getCurrentUserIndex, isIndexFound } from '../helpers/stories-carrossel';
import { toggleStoryModal } from '../helpers/toggleStoryModal';

export const useStoriesCarrossel = (items: Users[], dispatch: React.Dispatch<StoriesAction>,
